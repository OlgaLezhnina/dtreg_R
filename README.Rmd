...
The user can load a DTR schema (e.g., an ePIC datatype or an ORKG template) as an R object and create their own instance of the schema.
...
This example shows you how to work with a schema from a DTR; you need to know the identifier (URL) of the schema.
