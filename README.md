...
format. Currently, the ePIC and the ORKG DTRs are supported. The user
can load a DTR schema (an ePIC datatype or an ORKG template) as an R
object. The next step is to create a new instance of the schema by
filling the relevant fields. Finally, the instance can be written as a
...
“<https://doi.org/21.T11969/74bc7748b8cd520908bc>” is used. For the
ORKG, please use the ORKG template URL, such as
