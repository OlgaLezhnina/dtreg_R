...
[ORKG](https://orkg.org/) DTRs. \* First, load a DTR schema (an ePIC
datatype or an ORKG template) as an R object. \* Then, create a new
instance of the schema by filling in the relevant fields. \* Finally,
write the instance as a machine-actionable JSON-LD file.
