...
To load a DTR schema, you need to know its identifier (see the [help page](https://orkg.org/help-center/article/47/reborn_articles) ), such as the datatype DOI for the ePIC or the template URL for the ORKG.
