...
```
Please remember that this is a simplistic example, and in real tests you might want to report more details (e.g., the effect size for the Wilcoxon test).
...
```
A new R package based on dtreg will pack this code into just a couple of lines for simplicity, and you can look for the mrap package in CRAN soon. However, writing the results with dtreg as described here has its benefits, as it provides you with freedom of choice in presenting your results. 
