...
* Convert the results into the machine-readable JSON-LD format. 
...
Now we can add the information about the input data:
...
## 3. Convert the instance into the JSON-LD format

This stage is simple. This line gives you a string in the JSON-LD format:
