test_that("extract_epic gives the specified template", {
  ...
  expected <- c("$`PIDINST-SchemaObject`",                                           "$`PIDINST-SchemaObject`[[1]]",
                "                  name                     identifier schema_type", "1 PIDINST-SchemaObject 21.T11969/1ea0e148d9bbe08335cd      Object",
                "",                                                                  "$`PIDINST-SchemaObject`[[2]]",
                "[1] prop_name   type_id     cardinality nested     ",               "<0 rows> (or 0-length row.names)",
                "",                                                                  "")
